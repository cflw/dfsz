export module 东方山寨.关卡;
export import <map>;
export import "数学包含.h";
export import "基础.h";
export import "基础_事件.h";
...
public:
	...
	void f开始关卡(const tp关卡 &);	//在 C游戏::C实现::f事件_进入关卡 前调用,初始化控制状态,如果有关卡要先结束关卡
	void f初始化关卡();	//在 C游戏::C实现::f事件_进入关卡 中调用,确保部分游戏状态可以提前设置
	void f结束关卡();	//清空控制状态

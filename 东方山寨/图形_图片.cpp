...
#include "图形_画图片.h"
namespace 东方山寨 {
void C画图片动画::f显示图片(const S纹理 &a纹理, const S顶点矩形 *a顶点, const S动画缓冲 &a动画) {
	f显示图片3(a纹理, a顶点[a动画.m顶点序号], a动画.m坐标, a动画.m旋转, a动画.m缩放, a动画.m透明度);
}
...
const S纹理 *C图片动画图形::fg属性纹理() const {
	const S图片动画属性 &v属性 = fg图片动画属性();
	return v属性.m纹理.m指针;
}
const S顶点矩形 *C图片动画图形::fg属性顶点矩形() const {
	const S图片动画属性 &v属性 = fg图片动画属性();
	return v属性.m顶点.m指针;
}
const S顶点矩形 &C图片动画图形::fg当前顶点矩形() const {
	const S图片动画属性 &v属性 = fg图片动画属性();
...
void C图片动画图形缓冲::f初始化_图形(const C图片动画图形 &a) {
	const S图片动画属性 &v属性 = a.fg图片动画属性();
	m纹理 = v属性.m纹理.m指针;
	m顶点 = v属性.m顶点.m指针;
}
void C图片动画图形缓冲::f显示() const {
	C画图片动画::f显示图片(*m纹理, m顶点, *this);
}
//==============================================================================
// 顶点动画属性
//==============================================================================
...
// 快速图片动画
//==============================================================================
void C二维图片图形::C图形缓冲::f显示() const {
	C画图片动画::f显示图片2(*m纹理, *m顶点, m坐标, m旋转, m缩放, m透明);
}
void C二维图片图形::f接口_计算() {
	this->f事件_执行();
	f计算_运动();
...
// 快速图片动画
//==============================================================================
void C三维图片图形::C图形缓冲::f显示() const {
	C画图片动画::f显示图片3(*m纹理, *m顶点, m坐标, m旋转, m缩放, m透明);
}
void C三维图片图形::f接口_计算() {
	this->f事件_执行();
	f计算_运动();

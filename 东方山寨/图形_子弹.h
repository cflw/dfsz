...
public:	//函数
	...
	tp子弹图形数据 f生成点(const C子弹顶点::C点 &) override;
	tp子弹图形数据 f生成直线(const C子弹顶点::C直线 &, const C子弹顶点::C直线::ta顶点 &) override;
	tp子弹图形数据 f生成曲线(const C子弹顶点::C曲线 &, const C子弹顶点::C曲线::ta顶点 &) override;
	tp子弹图形数据 f生成连续点(const C子弹顶点::C曲线 &, const C子弹顶点::C曲线::ta顶点 &) override;
	tp子弹图形数据 f生成网格(const C子弹顶点::C网格 &, const C子弹顶点::C网格::ta顶点 &) override;

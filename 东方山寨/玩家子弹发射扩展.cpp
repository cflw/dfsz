...
void C灵梦诱导::f接口_产生子弹() {
	...
	m参数.m速度 = t向量2::fc方向r(c速度大小, v方向1);
	m工厂.f产生子弹<玩家子弹::C诱导>(m参数);
}
//==============================================================================
// 灵梦集中
//==============================================================================
...
void C魔理沙范围::f接口_产生子弹() {
	...
	m参数.m速度 = t向量2::fc方向r(c速度大小, v方向0);
	for (auto &v循环 : m参数.f循环(4)) {
		v循环.f变换模板_发散(m发射环境, c角度间隔, c坐标间隔);
		m工厂.f产生子弹<C玩家子弹>(m参数);
	}
}

...
class W选择自机 : public 用户界面::W窗口框架, public I跟踪界面语言 {
public:
...
module : private;
namespace 东方山寨 {
const 用户界面::S文本样式 W选择自机::c按钮文本样式 = {16, 用户界面::e居左};
W选择自机::W选择自机() {
	const std::tuple<int, std::wstring> va按钮[] = {
		{e测试, L"测试"},
		{e灵梦诱导, L"{character.reimu}\n    {character.reimu0}"},
		{e灵梦集中, L"{character.reimu}\n    {character.reimu1}"},
		{e魔理沙贯穿, L"{character.marisa}\n    {character.marisa0}"},
		{e魔理沙范围, L"{character.marisa}\n    {character.marisa1}"},
	};

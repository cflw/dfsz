...
//取属性数组数据指针
template<typename t> const ComPtr<t> &f取属性数组数据指针(const C属性数组<ComPtr<t>> &a数组, int a标识) {
	return a数组.fg数据(a标识);
}
template<typename t> const std::shared_ptr<t> &f取属性数组数据指针(const C属性数组<std::shared_ptr<t>> &a数组, int a标识) {
	return a数组.fg数据(a标识);
}
template<typename t> const t *f取属性数组数据指针(const C属性数组<t> &a数组, int a标识) {
	return a数组.fg指针(a标识);
}
template<typename t> auto &&C属性数组<t>::operator [](const std::wstring &a) const {
